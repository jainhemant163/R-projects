data.df <-read.csv(paste("C:/Users/JAINHEMANT/Desktop/Coursera Courses/Airlines Pricing Analysis Project Using R/AirLines_Quality_of_Analysis.csv", sep=""))#Loading the Data set
...
eco.df <-read.csv(paste("C:/Users/JAINHEMANT/Desktop/Coursera Courses/Airlines Pricing Analysis Project Using R/Economy.csv", sep=""))
library(Boruta)
...
pre.df <-read.csv(paste("C:/Users/JAINHEMANT/Desktop/Coursera Courses/Airlines Pricing Analysis Project Using R/TimingofFlights.csv", sep=""))
library(Boruta)
set.seed(1234) # for code reproducibility
